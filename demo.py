...
if __name__ == "__main__":
    ...
    parser.add_argument("--content_image", type=str, default="content/natural_scene/0001.png", help="content image path")
    parser.add_argument("--style_images", type=str, nargs='+', default=["style/NormalStyle/NS003.png", "style/NormalStyle/NS004.png"], help="List of style image paths")
    ...
    parser.add_argument("--print", type=bool, default=False, help="show cluster mathcing results")
